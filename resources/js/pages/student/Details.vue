        ...
        <v-container>
            ...
            <div :class="$vuetify.breakpoint.mdAndUp ? 'right-content' :'buttom-content'">
                <v-sheet width="300" height="320" elevation="12">
                    ...
                    <inertia-link :href="$route('student.apply',[course.id,batch_id])" class="v-center white--text font-weight-bold px-15 py-6 text-h6 my-5 v-btn v-btn--contained v-btn--rounded theme--light v-size--default green">
