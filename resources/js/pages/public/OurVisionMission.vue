<template>
    <About title="About UTC">
        <v-card>
            <v-img src="storage/images/vision-and-mission.jpg"></v-img>
            <v-card-title><v-icon left color="primary" large>mdi-trophy-award</v-icon> OUR MISSION</v-card-title>
            <v-card-text>
...
<script>
import About from '@/shared/public/components/About'
export default {
    props:{
    },
    components:{About}
